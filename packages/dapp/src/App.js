...
function App() {
  ...
  useEffect(() => {
    if (sliderModalVisible || highlightModalVisible) {
  ...
  }, [sliderModalVisible, highlightModalVisible]);

  return (
    <div className="mx-auto pb-32 bg-white selection:bg-green-300 selection:text-green-900">
      {/* <div className="bg-white z-40 invisible md:block fixed -top-12 h-48 w-full blur-lg md:blur-xl"></div>
      <div className="bg-white z-40 fixed -bottom-12 h-48 w-full blur-lg md:blur-xl"></div> */}
      ...
      >
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          ...
          <div>
            ...
            . The medium may be{' '}
            <a target="_blank" rel="noreferrer" href="https://youtu.be/8ZDEc7uFi64?t=3270">
              massaging ownership
            </a>{' '}
            to mean its{' '}
          ...
          <div>
            ...
            <a target="_blank" rel="noreferrer" href="https://robmyers.org/2014/07/24/ethereum-art-market/">
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          ...
          <div>
            ...
            meaningful legal rights, a point made explicit in signature
            economies. Just as there is{' '}
            <a target="_blank" rel="noreferrer" href="https://kernel.community/en/learn/module-2/money-speech/#math-beats-bureaucracy">
            ...
            <a target="_blank" rel="noreferrer" href="https://orionmagazine.org/article/the-rights-of-the-land/">
          ...
          <div>
            ...
            <a target="_blank" rel="noreferrer" href="https://kernel.community/en/learn/module-2/engineering/#further-references">
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          <div>
            All of which brings us to the word ‘signature’. It connotes both
            that which is irreducibly and uniquely you - your signature dish,
            signature tune, signature shot - and that which binds you
            contractually to a world beyond yourself. In{' '}
          ...
          <div>
            ...
            <a target="_blank" rel="noreferrer" href="https://emergencemagazine.org/story/the-serviceberry/">
              houses us all
            </a>
          ...
          <div>
            ...
            within a community who agrees upon their use, which is why language
            itself is the only{' '}
            <a target="_blank" rel="noreferrer" href="https://medium.com/@VitalikButerin/the-meaning-of-decentralization-a0c92b76a274">
          ...
          <div>
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/crytic/evm-opcodes">opcodes</a>, and
            executable speech. The value of such economies is held in{' '}
            <a target="_blank" rel="noreferrer" href="https://libraryofbabel.info/bookmark.cgi?findintheway">
              positively signed
            </a>{' '}
            ...
            experience harmoniously what words like dao signify in their
            personal contexts.
          </div>
          <div>
            How can I take responsibility without the resources to make my
            signature meaningful, though? I have tried to use{' '}
            <a target="_blank" rel="noreferrer" href="https://medium.com/@cryptowanderer/merry-merkle-magic-1458a25ee2dd">
              words to speak my imagination
            </a>{' '}
            into existence, and have seen the limits of such work. My signatures
            do not move markets. However, markets are not the arbiters of
            meaning, they are mechanisms for efficient resource allocation. Your
            signature is not made meaningful by its effects: your signature is
            meaningful by virtue of its singular existence. New forms of
            ignorance and{' '}
            <a target="_blank" rel="noreferrer" href="https://youtu.be/3HYlbg6RKMA?t=1145">
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          <div>
            ...
            be the{' '}
            <a target="_blank" rel="noreferrer" href="https://www.interdependence.online/declaration/e-bw-AGkYsZFYqmAe2771A6hi9ZMIkWrkBNtHIF1hF4">
          ...
          <div>
            ...
            <a target="_blank" rel="noreferrer" href="https://ethereum.foundation/philosophy/">
          ...
          <div>
            Seek to improve the people around you by humbling yourself and
            handing over power at every chance, without shirking responsibility.
          ...
          <div>
            ...
            <i>
              <a target="_blank" rel="noreferrer" href="http://www.dictionaryofspiritualterms.com/public/Glossaries/terms.aspx?ID=352">
                sunthemata
              </a>
            </i>
            : divine symbols within all existence meant to assist the soul on
            its journey from, and back to, grace. When we leave a token of love
            or appreciation for no reason other than the simple recognition that
            ...
            world, but the superset which marks what I already mean, which
            re-members this singular human response to our shared being.
          </div>
        </div>
      ...
      <footer className="py-10 font-mono text-center text-sm text-gray-600 items-center">
        ...
        font-body text-xs md:text-sm text-gray-600 content-center"
        >
