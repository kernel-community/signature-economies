      ...
      >
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          ...
          <div>
            ...
            . The medium may be{' '}
            <a href="https://youtu.be/8ZDEc7uFi64?t=3270">
              massaging ownership
            </a>{' '}
            to mean its{' '}
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          ...
          <div>
            ...
            shared record with{' '}
            <a href="injustice will always appear">true beauty</a>.
          </div>
        </div>
        ...
        <div className="mx-auto flex flex-col px-8 md:px-0 py-16 w-full md:w-[800px] gap-y-12 text-md md:text-2xl font-garamond text-justify items-center justify-center">
          ...
          <div>
            ...
            <a href="https://youtu.be/LwLP62fL83k?t=572">courage</a> to sign the{' '}
        ...
        <div className="mx-auto flex flex-col w-full md:w-[600px] pb-16 px-8 md:px-0 text-md md:text-2xl font-garamond text-center text-gray-800">
          “It is not we who are permitted to ask about the meaning of life — it
          is life that asks the questions [...] We are the ones who must give
          answers to the constant, hourly question of life [...] Living itself
          means nothing other than being questioned; our whole act of being is
          nothing more than responding to — of being responsible toward — life
          [...] now the present is everything as it holds the eternally new
          question of life for us.” <br />
          <br />
