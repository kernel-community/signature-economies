...
export class SignCreated extends ethereum.Event {
  get params(): SignCreated__Params {
    return new SignCreated__Params(this);
  }
}

export class SignCreated__Params {
  _event: SignCreated;

  constructor(event: SignCreated) {
    this._event = event;
  }
...
export class SignatureFund__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class SignatureFund extends ethereum.SmartContract {
  static bind(address: Address): SignatureFund {
    return new SignatureFund("SignatureFund", address);
  }

  arweaveBase(): string {
    let result = super.call("arweaveBase", "arweaveBase():(string)", []);

    return result[0].toString();
  }

  try_arweaveBase(): ethereum.CallResult<string> {
    let result = super.tryCall("arweaveBase", "arweaveBase():(string)", []);
    if (result.reverted) {
  ...
  royaltyInfo(param0: BigInt, value: BigInt): SignatureFund__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new SignatureFund__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    param0: BigInt,
    value: BigInt
  ): ethereum.CallResult<SignatureFund__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SignatureFund__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
...
export class CreateSignCall extends ethereum.Call {
  get inputs(): CreateSignCall__Inputs {
    return new CreateSignCall__Inputs(this);
  }

  get outputs(): CreateSignCall__Outputs {
    return new CreateSignCall__Outputs(this);
  }
}

export class CreateSignCall__Inputs {
  _call: CreateSignCall;

  constructor(call: CreateSignCall) {
    this._call = call;
  }

  get selectedNFT(): string {
    return this._call.inputValues[0].value.toString();
  }
}

export class CreateSignCall__Outputs {
  _call: CreateSignCall;
