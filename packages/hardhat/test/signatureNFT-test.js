  ...
  describe("Sign", function () {
    ...
    describe("minting", function () {
      it("the uri associated with the NFT should be what anyone passes in", async function () {
        ...
        expect (await this.signatureNFT.tokenURI(0)).to.equal("data:application/json;base64,");
      })
      it("should revert if passed invalid indices", async function () {
        ...
        const tx4 = this.signatureNFT.mintSelected(ethers.BigNumber.from(0), ethers.BigNumber.from(511));
