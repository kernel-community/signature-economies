...
function useFullscreen(options) {
    ...
    var _b = (0, react_1.useState)(Boolean(document[fullscreenControls.fullscreenElement])), isFullscreen = _b[0], setIsFullscreen = _b[1];
    var _c = (0, react_1.useState)(document[fullscreenControls.fullscreenElement]), element = _c[0], setElement = _c[1];
    var request = (0, react_1.useCallback)(function (element) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var exit = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var toggle = (0, react_1.useCallback)(function (newElement) {
    ...
    (0, useDocumentEventListener_1.useDocumentEventListener)(fullscreenControls.fullscreenchange, function (event) {
        var _a;
    ...
    (0, useDocumentEventListener_1.useDocumentEventListener)(fullscreenControls.fullscreenerror, function (event) {
        var _a;
