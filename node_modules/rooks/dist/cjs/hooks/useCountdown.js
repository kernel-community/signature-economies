...
function useCountdown(endTime, options) {
    ...
    var _b = (0, react_1.useState)(function () { return new Date(); }), time = _b[0], setTime = _b[1];
    var restTime = endTime.getTime() - time.getTime();
    var count = restTime > 0 ? Math.ceil(restTime / interval) : 0;
    (0, useIntervalWhen_1.useIntervalWhen)(onTick, count ? interval : undefined, true, true);
    return count;
    function onTick() {
