...
var useDebouncedValue = function (value, timeout, options) {
    ...
    var _a = (0, react_1.useState)(initializeWithNull ? null : value), updatedValue = _a[0], setUpdatedValue = _a[1];
    var debouncedSetUpdatedValue = (0, useDebounce_1.useDebounce)(setUpdatedValue, timeout);
