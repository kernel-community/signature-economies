...
function useMultiSelectableList(list, initialSelectIndices, allowUnselected) {
    ...
    var _a = (0, react_1.useState)(initialSelectIndices), currentIndices = _a[0], setCurrentIndices = _a[1];
    ...
    var toggleSelectionByIndex = (0, react_1.useCallback)(function (index) {
        var newIndices;
